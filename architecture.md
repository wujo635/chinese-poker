...
src/
  ...
  components/       # React UI components
    ...
    Home.tsx          # New Game (session mode + seat-count picker) / Continue Saved Game
    ...
    ResultsScreen.tsx     # Post-round reveal: Dealer's matchups vs each opponent, round-total summary, all hands revealed
